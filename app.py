...
if 'split_content1' not in st.session_state:
...
def update_split_content1():
    st.session_state.split_content1 = st.session_state.split_content1_checkbox

def update_split_content2():
    st.session_state.split_content2 = st.session_state.split_content2_checkbox
...
def main():
    ...
    if selected == "PDF截圖與AI文案":
        ...
        if options == "每頁商品數固定":
            ...
            st.checkbox("自動將文案分割為不同欄位", value=st.session_state.split_content1, key='split_content1_checkbox', on_change=update_split_content1, help="勾選後將自動依據文案格式中的【】和〖〗來將主題、標題與文案分割為不同欄位，但同時prompt中就必須要求使用特定的文案格式\n\n【指定的主題】\n\n〖標題〗\n\n1.文案1\n\n2.文案2\n\n3.······")
            ...
            if missing_fields:
                ...
                with zipfile.ZipFile(zip_buffer, 'w') as zipf:
                    ...
                    if not_found:
                        ...
                        st.error("有特定貨號不存在於PDF中，請參考ZIP檔中的錯誤說明檔。")
